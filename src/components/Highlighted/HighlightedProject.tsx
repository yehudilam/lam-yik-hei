...
const projects = [
  ...
  },
  {
    ...
    stack: ["Typescript", "Material-UI", "React"],
    mdx: csMdx,
  },
  {
    title: "CLP Smart Energy Connect",
    image: clp,
    stack: ["Typescript", "GraphQL", "Tailwind CSS", "Material-UI", "React"],
    mdx: clpMdx,
  },
  {
    title: "Carbon Coins",
...
const HighlightedProject = () => {
  ...
  useEffect(() => {
    selectedProject && window.document.addEventListener("keydown", escapeKeyDown);

    return () => window.document.removeEventListener("keydown", escapeKeyDown);
    ...
    <>
      <ProjectsWrapper>
        {projects.map((project) => (
          <HighlightedProjectCard project={project} setSelected={openModal} />
        ))}
      </ProjectsWrapper>
